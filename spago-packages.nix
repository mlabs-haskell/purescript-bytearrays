  ...
  inputs = {
    ...
    "aeson" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "2d482496277d28db64d853f8e63c9046e8a90878";
          sha256 = "1zfgc723rx865h9s5m0xky20903pfvz4zmlg2a71vw1dfzsz9ba6";
        };
        phases = "installPhase";
    ...
    "js-bigints" = pkgs.stdenv.mkDerivation {
        ...
        version = "v2.1.0";
        src = pkgs.fetchgit {
          url = "https://github.com/purescript-contrib/purescript-js-bigints.git";
          rev = "afdf6fa51635ca9d7c4c90762d3bff5693e0ed09";
          sha256 = "0jc30gyy3c9is1mq90b00qi06j0q2nwxzxpmml5r68ldi179mkfn";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
